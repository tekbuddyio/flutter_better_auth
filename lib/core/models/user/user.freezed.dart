...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,email,emailVerified,image,createdAt,updatedAt,twoFactorEnabled,username,displayUsername,isAnonymous,phoneNumber,phoneNumberVerified,role,banned,banReason,banExpires,status,completeProfile]);

@override
String toString() {
  return 'User(id: $id, name: $name, email: $email, emailVerified: $emailVerified, image: $image, createdAt: $createdAt, updatedAt: $updatedAt, twoFactorEnabled: $twoFactorEnabled, username: $username, displayUsername: $displayUsername, isAnonymous: $isAnonymous, phoneNumber: $phoneNumber, phoneNumberVerified: $phoneNumberVerified, role: $role, banned: $banned, banReason: $banReason, banExpires: $banExpires, status: $status, completeProfile: $completeProfile)';
}
...
as String?,completeProfile: freezed == completeProfile ? _self.completeProfile : completeProfile // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  bool emailVerified,  String? image,  DateTime? createdAt,  DateTime? updatedAt,  bool twoFactorEnabled,  String? username,  String? displayUsername,  bool isAnonymous,  String? phoneNumber,  bool phoneNumberVerified,  String? role,  bool banned,  String? banReason,  DateTime? banExpires,  String? status,  bool? completeProfile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.emailVerified,_that.image,_that.createdAt,_that.updatedAt,_that.twoFactorEnabled,_that.username,_that.displayUsername,_that.isAnonymous,_that.phoneNumber,_that.phoneNumberVerified,_that.role,_that.banned,_that.banReason,_that.banExpires,_that.status,_that.completeProfile);case _:
  return orElse();
...
@override final  bool? completeProfile;
